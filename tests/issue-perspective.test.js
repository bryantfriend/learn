...
test('another lesson retains its existing checkpoint',()=>{
 const other={...saved,lessonId:'g7b-gp-w01-3',contentRevision:getLesson('g7b-gp-w01-3').contentRevision,steps:getLesson('g7b-gp-w01-3').stages.map(()=>0),discussedQuestions:[]};
