...
Students can study at **https://bryantfriend.github.io/learn/students/**. The library covers every published lesson with notes, diagrams, recall cards, practice and a personal notebook. It supports English, Russian, Simplified Chinese and Turkish, with optional English comparisons. A lesson-specific WhatsApp help link reaches Mr. Friend. Student notes and progress stay in their browser. See [the student guide](docs/students.md) for generation, translation and testing details.
